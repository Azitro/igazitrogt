...
def main():
    ...
    {Style.BRIGHT + Fore.RED}█    ▀▄▄▄▀    █             {Style.BRIGHT + Fore.YELLOW}Coded by Azitro // İnstagram: @spectaross{Style.RESET_ALL}
    {Style.BRIGHT + Fore.RED}▀▄▄▄▄▄▄▄▄▄▄▄▄▄▀{Style.RESET_ALL}
    ...
    if ("Azitro" not in logo):
        print("Bu programı Azitro'dan çaldım ve o kadar malım ki bunu da kaldırmayı unuttum.")
        exit(0)
